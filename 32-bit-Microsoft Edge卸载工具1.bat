...
if "%EdgeFilesDrive%"=="Y" cls & cd %HOMEPATH%\AppData\Local\Microsoft\EdgeWebView\Application\*.0.* & .\msedgewebview2.exe -uninstall -system-level -verbose-logging -force-uninstall & cls & echo 由于Microsoft的限制，所以请进入控制面板卸载WebView（Microsoft Edge WebView2 Runtime） & echo 请卸载后按任意键再继续卸载！请卸载Microsoft Edge WebView2 Runtime后再继续卸载！如果无法卸载（卸载点击无反应），那么直接继续下一步即可 & rundll32.exe shell32.dll,Control_RunDLL appwiz.cpl & @pause & %EdgeFilesDrive% & cd "%EdgeFilesDrive%\Program Files\Microsoft\EdgeCore\*.0.*\Installer" & .\setup.exe -uninstall -system-level -verbose-logging -force-uninstall & cd "%EdgeFilesDrive%\Program Files\Microsoft\EdgeWebView\Application\*.0.*" & .\msedgewebview2.exe -uninstall -system-level -verbose-logging -force-uninstall & cd "%EdgeFilesDrive%\Program Files\Microsoft\Edge\Application\*.0.*\Installer" & .\setup.exe -uninstall -system-level -verbose-logging -force-uninstall & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & rd /s /q "%EdgeFilesDrive%\Users\Admin\AppData\Local\Microsoft\Edge" & rd /s /q "%EdgeFilesDrive%\ProgramData\Microsoft\EdgeUpdate" & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeBCHost.exe & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeCP.exe & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeDevTools.exe & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeSH.exe & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-100_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-100.png" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0___8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-200.png" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\Clipchamp.Clipchamp_2.2.8.0_neutral__yxz26nhyzhsrt\Runtimes\MicrosoftEdgeWebview2Setup.exe" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\MicrosoftWindows.Client.WebExperience_421.20070.195.0___cw5n1h2txyewy\Dashboard\WebView2Loader.dll" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeBCHost.exe /p everyone:f /e & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeCP.exe /p everyone:f /e & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeDevTools.exe /p everyone:f /e & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeSH.exe /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-100_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-100.png" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0___8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-200.png" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\Clipchamp.Clipchamp_2.2.8.0_neutral__yxz26nhyzhsrt\Runtimes\MicrosoftEdgeWebview2Setup.exe" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\MicrosoftWindows.Client.WebExperience_421.20070.195.0___cw5n1h2txyewy\Dashboard\WebView2Loader.dll"  /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png"  /p everyone:f /e & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeBCHost.exe & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeCP.exe & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeDevTools.exe & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeSH.exe & del "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-100_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-100.png" & del "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0___8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-200.png" & del "%EdgeFilesDrive%\Program Files\WindowsApps\Clipchamp.Clipchamp_2.2.8.0_neutral__yxz26nhyzhsrt\Runtimes\MicrosoftEdgeWebview2Setup.exe" & del "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & del "%EdgeFilesDrive%\Program Files\WindowsApps\MicrosoftWindows.Client.WebExperience_421.20070.195.0___cw5n1h2txyewy\Dashboard\WebView2Loader.dll" & del "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & rd /s /q "%EdgeFilesDrive%\Users\Administrator\AppData\Local\Microsoft\Internet Explorer\Indexed DB\EDGE" rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft\EdgeWebView" & rd /s /q "%EdgeFilesDrive%\Administrator\Desktop\EdgeUpdate 1" & rd /s /q "%EdgeFilesDrive%\Internet 临时文件\IE\3MXLTGBM" & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & del "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.LanguageExperiencePackzh-CN_22621.9.50.0_neutral__8wekyb3d8bbwe\windows\System32\Dism\zh-CN\c15cf26162248a030c229312f4f7709c\EdgeProvider.dll.mui" & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\Edge & taskkill /im MicrosoftEdgeUpdate.exe /f & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeUpdate & cd %HOMEPATH%\AppData\Local\Microsoft\EdgeCore\*.0.*\Installer & .\setup.exe -uninstall -system-level -verbose-logging -force-uninstall & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeCore & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeWebView & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeUpdate & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\Edge & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeCore
if "%EdgeFilesDrive%"=="y" cls & cd %HOMEPATH%\AppData\Local\Microsoft\EdgeWebView\Application\*.0.* & .\msedgewebview2.exe -uninstall -system-level -verbose-logging -force-uninstall & cls & echo 由于Microsoft的限制，所以请进入控制面板卸载WebView（Microsoft Edge WebView2 Runtime） & echo 请卸载后按任意键再继续卸载！请卸载Microsoft Edge WebView2 Runtime后再继续卸载！如果无法卸载（卸载点击无反应），那么直接继续下一步即可 & rundll32.exe shell32.dll,Control_RunDLL appwiz.cpl & @pause & %EdgeFilesDrive% & cd "%EdgeFilesDrive%\Program Files\Microsoft\EdgeCore\*.0.*\Installer" & .\setup.exe -uninstall -system-level -verbose-logging -force-uninstall & cd "%EdgeFilesDrive%\Program Files\Microsoft\EdgeWebView\Application\*.0.*" & .\msedgewebview2.exe -uninstall -system-level -verbose-logging -force-uninstall & cd "%EdgeFilesDrive%\Program Files\Microsoft\Edge\Application\*.0.*\Installer" & .\setup.exe -uninstall -system-level -verbose-logging -force-uninstall & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & rd /s /q "%EdgeFilesDrive%\Users\Admin\AppData\Local\Microsoft\Edge" & rd /s /q "%EdgeFilesDrive%\ProgramData\Microsoft\EdgeUpdate" & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeBCHost.exe & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeCP.exe & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeDevTools.exe & takeown /f %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeSH.exe & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-100_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-100.png" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0___8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-200.png" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\Clipchamp.Clipchamp_2.2.8.0_neutral__yxz26nhyzhsrt\Runtimes\MicrosoftEdgeWebview2Setup.exe" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\MicrosoftWindows.Client.WebExperience_421.20070.195.0___cw5n1h2txyewy\Dashboard\WebView2Loader.dll" & takeown /f "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeBCHost.exe /p everyone:f /e & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeCP.exe /p everyone:f /e & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeDevTools.exe /p everyone:f /e & cacls %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeSH.exe /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-100_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-100.png" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0___8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-200.png" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\Clipchamp.Clipchamp_2.2.8.0_neutral__yxz26nhyzhsrt\Runtimes\MicrosoftEdgeWebview2Setup.exe" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\MicrosoftWindows.Client.WebExperience_421.20070.195.0___cw5n1h2txyewy\Dashboard\WebView2Loader.dll"  /p everyone:f /e & cacls "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png"  /p everyone:f /e & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeBCHost.exe & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeCP.exe & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeDevTools.exe & del %EdgeFilesDrive%\Windows\System32\MicrosoftEdgeSH.exe & del "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-100_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-100.png" & del "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.WindowsFeedbackHub_1.2201.61.0___8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-200.png" & del "%EdgeFilesDrive%\Program Files\WindowsApps\Clipchamp.Clipchamp_2.2.8.0_neutral__yxz26nhyzhsrt\Runtimes\MicrosoftEdgeWebview2Setup.exe" & del "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & del "%EdgeFilesDrive%\Program Files\WindowsApps\MicrosoftWindows.Client.WebExperience_421.20070.195.0___cw5n1h2txyewy\Dashboard\WebView2Loader.dll" & del "%EdgeFilesDrive%\Program Files\WindowsApps\DeletedAllUserPackages\Microsoft.WindowsFeedbackHub_1.2201.61.0_neutral_split.scale-125_8wekyb3d8bbwe\Assets\Images\EdgeLogo.scale-125.png" & rd /s /q "%EdgeFilesDrive%\Users\Administrator\AppData\Local\Microsoft\Internet Explorer\Indexed DB\EDGE" rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft\EdgeWebView" & rd /s /q "%EdgeFilesDrive%\Administrator\Desktop\EdgeUpdate 1" & rd /s /q "%EdgeFilesDrive%\Internet 临时文件\IE\3MXLTGBM" & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & del "%EdgeFilesDrive%\Program Files\WindowsApps\Microsoft.LanguageExperiencePackzh-CN_22621.9.50.0_neutral__8wekyb3d8bbwe\windows\System32\Dism\zh-CN\c15cf26162248a030c229312f4f7709c\EdgeProvider.dll.mui" & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft" & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\Edge & taskkill /im MicrosoftEdgeUpdate.exe /f & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeUpdate & cd %HOMEPATH%\AppData\Local\Microsoft\EdgeCore\*.0.*\Installer & .\setup.exe -uninstall -system-level -verbose-logging -force-uninstall & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeCore & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeWebView & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeUpdate & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\Edge & rd /s /q %HOMEPATH%\AppData\Local\Microsoft\EdgeCore
cls
...
reg delete "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Compatibility Assistant\Store" /v "%pf%:\Program Files\Microsoft\Edge\Application\msedge.exe" /f
...
del "%pf%:\Program Files\Microsoft" /q
...
cd %SYSTEMDRIVE% & rd /s /q "%EdgeFilesDrive%\Program Files\Microsoft"
del %SYSTEMDRIVE%\MSi版Edge卸载所需程序.txt
...
@ color 2 & echo 当前版本：2.7.3.0（32位系统版）更新内容：修复了小写无法卸载，添加了Windows搜索网页功能的开启与关闭，修复了上一个版本更新后仍存在残留的打开方式的问题，添加了Windows10及以下IE图标修复，支持自动识别当前磁盘的盘符 & cls
echo 当前版本：2.7.4.0（32位系统版）更新内容：修复了Microsoft Edge无法卸载的BUG，修改了Microsoft Edge WebView2 Runtime部分的提示框，修改了最开始选择硬盘界面的选择逻辑，减小了程序体积，并将“回车”问题修正了，修复了Internet Explorer修复工具下载错误的问题，修复了Windows Search无法关闭的问题，修改了部分显示文字， & CLS
echo 如果释放了一个名为“Packages.txt”的文件，在卸载完edge后删除即可 & cls
echo 当前版本：2.7.5.0（32位系统版）更新内容：修复了Internet Explorer、Microsoft Edge降级包无法下载的问题
pause & cls
